...
public class DatabaseConnectivity {
    ...
    public static List<Shape> getPaints(String tbName) {
        ...
        try (ResultSet rs = stmt.executeQuery(sql)) {
            while (rs.next()) {
                Shape shape = new Shape(Integer.parseInt(rs.getString(1)), Integer.parseInt(rs.getString(2)),
    ...
    public static void addPaints(List<Shape> list, String user) {
        ...
        for (int i = 0; i < list.size(); i++) {
            ...
            String sql = "INSERT INTO paintproject." + user + " (`intX`, `intY`, `intEndX`, `intEndY`, `color`, `modol`)\n"
                    + "VALUES ('" + shape.getStartX() + "', '" + shape.getStartY() + "', '" + shape.getEndX() + "', '" + shape.getEndY() + "', '" + shape.getColor() + "', '" + shape.getModelShape() + "');";
    ...
    private static int createUser(String user, String pass) {
        ...
        sql = "INSERT INTO `username` (`User`, `Pass`) VALUES ('" + user + "', '" + pass + "');";
