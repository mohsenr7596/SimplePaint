package app;//GEN-FIRST:event_jButton1ActionPerformed
...
public class SimplePaint extends javax.swing.JFrame {
    ...
    private void paintPanelMousePressed(java.awt.event.MouseEvent evt) {                                        

        startX = evt.getX();
        startY = evt.getY();
    }                                       

    private void paintPanelMouseReleased(java.awt.event.MouseEvent evt) {                                         
    ...
    private void colorChangeButtonActionPerformed(java.awt.event.ActionEvent evt) {                                                  
